...
define config.name = _("Baby's First Visual Novel Prototype")
...
define build.name = "BabysFirstVisualNovelPrototype"
...
define config.save_directory = "BabysFirstVisualNovelPrototype-1542241094"
