...
screen credits():
    ...
    frame at credits_scroll(50.0):
        ...
        vbox:
            ...
            text "{b}Frederik \"Flumpor\" Haas{/b}\nScrum Master, Coding, Minigames, Gamedesigner, Dialektmensch\n\n" at left
            text "{b}Kilian \"Raghnal\" Petry{/b}\nLead Scenedesigner, Lead Coder, Animator, Playtester, Gamedesigner\n\n" at left
            text "{b}Natalie \"Illuminati\" Kuhrt{/b}\nLead Artist, Writer, Coder, Scenedesigner, Playtester, Gamedesigner, Lizenzberatung\n\n" at left
            ...
            text "{b}Alle oben aufgezählten Musikstücke sind von der Youtube Audio Library:{/b}\nhttps://www.youtube.com/audiolibrary/music?ar=2\n\n" at left
            text "Bad Snacks - {b}Kawaii!{/b}\nhttps://soundcloud.com/bad-snacks/kawaii\n" at left
            text "Emily A. Sprague - {b}Mind And Eye Journey{/b}\nhttps://soundcloud.com/mlesprg\n" at left
            text "Quincas Moreira - {b}Rainbow Forest{/b}\nQuincas Moreira - {b}Bubinga{/b}\nhttps://9tube.tv/channel/UCrZmIGWwmhX-XhWYqAio6aQ (Royalty Free Music)\n" at left
            text "The 129ers - {b}We Can Hear You Big Eyes{/b}\nhttps://soundslibmp3.ru/download/cinema/we-can-hear-you-big-eyes\n" at left 
            text "The Green Orbs - {b}Racing The Clock{/b}\nThe Green Orbs - {b}Broccoli On My Plate{/b}\nThe Green Orbs - {b}After School Jamboree{/b}\nhttps://muzlan.top/en/search/The+Green+Orbs\n" at left
            text "{b}Creative Commons Attribution (https://creativecommons.org/licenses/by/3.0/)\n\n" at left
            text "Twin Musicom - {b}Video game Soldiers{/b}\nCreative Commons Attribution (https://creativecommons.org/licenses/by/4.0/)\nhttp://www.twinmusicom.org/song/295/video-game-soldiers\n" at left
