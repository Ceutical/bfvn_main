...
label scene3:
    ...
    show randy happy at slightleft behind octa
    with moveinbottom
    k "Gut, dann legen wir mal los... Wir spielen wieder das Käfergruppenlied! Holt doch alle schon mal eure Instrumente aus der Kiste."
...
label scene9:
    ...
    "???" "Wir haben doch gestern schon gesungen!"
...
label scene15:
    ...
    a "Mit den Hula Hoop Reifen bin ich viel besser als wie du!"
...
label scene20:
    ...
    show rparty vhappy
    r "Nein. Neues Schwein, muss es sein!"
    menu:
        "Ich möchte anfangen.":
            $ eve_points += 2
...
#JUMPER
    if anja_points >= eve_points and anja_points > octa_points:
        ...
        show karin go at rightish
        with fade
        k "Leider ein --- zurück--- Mädchen. Beide nehmen---Freundschaft mit, denn--- Kokon heraus."
        k "Am Freitag werde..."
        show mum happy
        show karin n
